      ...
      <v-col cols="12" sm="6">
        ...
        <v-row>
          ...
          <v-select
            ...
            :items="['collect', 'add', 'fill', 'ratio', 'ratio_prioritized']"
...
modesMap.set("ratio_prioritized", "ratio_prioritized")
...
reversedModesMap.set("ratio_prioritized", "ratio_prioritized")
